            ...
            <div class="card">
                ...
                <form enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="show_description" id="show_description" placeholder="optional description" value="{{$show->show_description}}" disabled></textarea>
                        </div>
                    </div>
