...
var audio = new Audio("http://www.undergroundradio.gr/listen/live.html"), // change to your own!

//var audio = new Audio($(function() { $('#videoPlayer').player('play', 'http://www.undergroundradio.gr/listen/live.html');})),
